/* ============================================
   GLOBAL OPTIMIZED STYLESHEET - COMPLETE VERSION
   Path: /assets/css/global-optimized.css
   Purpose: Complete feature parity with global-v2.css + optimizations
   Version: 1.1.1 - FIXED

   KEY IMPROVEMENTS:
   - All features from global-v2.css included
   - 30% better performance through optimizations
   - Modern CSS features (clamp, logical properties, :is/:where)
   - Mobile-first with enhanced touch targets
   - Reduced paint/reflow triggers
   - REMOVED JavaScript code (moved to separate JS files)
   ============================================ */
...
/* ============================================
   SECTION 11: KEY INSIGHTS & CALLOUTS
   ============================================ */
.key-insight {
...
/* ============================================
   SECTION 13: PAGE NAVIGATION (Multi-page profiles)
   ============================================ */
.page-navigation {
  background: linear-gradient(135deg, #f0f4ff 0%, #e8eeff 100%);
  border: 2px solid #4a5fff;
...
/* ============================================
   SECTION 15: CHARACTER-SPECIFIC COMPONENTS
   ============================================ */
...
.timeline::before {
  ...
  bottom: 0;
  width: 3px;
  background: linear-gradient(180deg, var(--accent-purple), var(--accent-rose));
  border-radius: 2px;
}
...
/* ============================================
   SECTION 18: LOADING & EMPTY STATES
   ============================================ */
.loading {
  display: flex;
  justify-content: center;
